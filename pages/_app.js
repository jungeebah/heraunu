...
const MyApp = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Complete Nepali Movie Database for viewing Nepali Movies|Hearuna</title>
                <meta
                    name="description"
                    content="Hearuna is a site for Nepali Movie lovers to come and find viewing locations."
                />
