...
const MyApp = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Complete Nepali Movie Database for viewing Nepali Movies|Hernechu</title>
                <meta
                    name="description"
                    content="Hernechu is a site for Nepali Movie lovers to come and find viewing locations."
                />
